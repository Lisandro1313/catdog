...
(snake con la cara del gato real, `public/gato.png`, y los dos perros, `public/perro*.png`, como obstáculo; deslizar o flechas), **los de la casa** (topo: asoman Lisandro, el gato, los perros e ingredientes dorados; el chef y el fuego restan; varios a la vez y racha con bonus), **ritmo de la casa** (guitar hero de 4 carriles con melodías de dominio público — La cumparsita, El choclo, La morocha, Arroz con leche, Feliz cumpleaños, Mambrú, La farolera, Para Elisa, Can-can — con velocidad lento/normal/rápido (×0,7 / ×1 / ×1,5 en puntos) sintetizadas con Web Audio; la nota suena solo si la pegás), **memotest** con las fotos de la
...
**verdadero o falso** de barra (50 preguntas en `src/lib/jugar.ts`; racha hasta el primer error, con reloj).
Simón suena (Web Audio, una nota por ingrediente) y toma 4 ingredientes al azar de 12 por partida. Ningún puntaje
tiene techo: los récords no empatan en 100 %.
